                        ...
                        <form method="post" action="{{ route('patients.update',$patient) }}">
                            ...
                            <h4 class="mb-3">Contact Information</h4>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="ssn" value="{{$patient->ssn}}">
                                </div>
                            <h4 class="mb-3">Address</h4>
                                ...
                                <div class="mb-3">
                                    <select  class="form-control" name="state">
                                        <option value="{{$patient->state}}" selected="selected">{{$patient->state}}</option>
                            ...
                            <h4 class="mb-3">Case Description</h4>
                                <div class="mb-3 form-group">
                                    ...
                                    <textarea class="form-control" name="case_description" rows="3">{{$patient->case_description}}</textarea>
                                </div>
                            <h4 class="mb-3">Allergies</h4>
                                <div class="mb-3 form-group">
                                    <label for="food_allergies">Food Allergies</label>
                                    <textarea class="form-control" name="food_allergies" rows="3">{{$patient->food_allergies}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="medicine_allergies">Medicine Allergies</label>
                                    <textarea class="form-control" name="medicine_allergies" rows="3">{{$patient->medicine_allergies}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="insect_allergies">Insect Allergies</label>
                                    <textarea class="form-control" name="insect_allergies" rows="3">{{$patient->insect_allergies}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="other_allergies">Other Allergies</label>
                                    <textarea class="form-control" name="other_allergies" rows="3">{{$patient->other_allergies}}</textarea>
                                </div>
                            <h4 class="mb-3">Illnesses</h4>
                                <div class="mb-3 form-group">
                                    <label for="previous_illnesses">Previous Illnesses</label>
                                    <textarea class="form-control" name="previous_illnesses" rows="3">{{$patient->previous_illnesses}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="current_illnesses">Current Illnesses</label>
                                    <textarea class="form-control" name="current_illnesses" rows="3">{{$patient->current_illnesses}}</textarea>
                                </div>
                            <h4 class="mb-3">Physical Condition</h4>
                                <div class="mb-3 form-group">
                                    <label for="physical_disabilities">Physical Disabilities</label>
                                    <textarea class="form-control" name="physical_disabilities" rows="3">{{$patient->physical_disabilities}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="respitory_condition">Respitory Condition</label>
                                    <textarea class="form-control" name="respitory_condition" rows="3">{{$patient->respitory_condition}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="heart_condition">Heart Condition</label>
                                    <textarea class="form-control" name="heart_condition" rows="3">{{$patient->heart_condition}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="hearing_condition">Hearing Condition</label>
                                    <textarea class="form-control" name="hearing_condition" rows="3">{{$patient->hearing_condition}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="visual_condition">Visual Condition</label>
                                    <textarea class="form-control" name="visual_condition" rows="3">{{$patient->visual_condition}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="siezures">Siezures</label>
                                    <textarea class="form-control" name="siezures" rows="3">{{$patient->siezures}}</textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="current_medications">Current Medications</label>
                                    <textarea class="form-control" name="current_medications" rows="3">{{$patient->current_medications}}</textarea>
                                </div>
